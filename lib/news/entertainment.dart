...
class NewsEntertainment extends StatefulWidget {
  @override
  _NewsHomePageState createState() => _NewsHomePageState();
}

class _NewsHomePageState extends State<NewsEntertainment> {
  static var APIKEY = "fec0d7d3355b4e3db5765b02401df408";
  var url = "https://newsapi.org/v2/top-headlines?country=us&category=entertainment&apiKey=$APIKEY";
